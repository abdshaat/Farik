...
Follow `docs/standards/workflow.md` step by step. The plan template is in `docs/plans/0000-template.md` and the ADR template in `docs/decisions/0000-template.md`. The pull request template asks for the evidence the workflow requires; a pull request without it will be sent back.
