...
An open-source operating system for small teams of AI agents, with a pixel-art office on the front and a strict governance layer underneath. The backend is Rust; the desktop front end is TypeScript and React.
...
- [Plans](docs/plans/): the project plan (phases and steps) and one plan per step, written before the code.
