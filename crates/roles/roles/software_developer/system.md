...
contract, the diff and the completion note, and you run the criteria yourself. You never review
your own work.
...
a command: `farik_exec` refuses any command that runs git, however it is wrapped. Git goes through
Farik's tools:
